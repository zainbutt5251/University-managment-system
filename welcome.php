...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="User/vendors/popup/magnific-popup.css">
        <!-- main css -->
        		...
        		<div class="row courses_inner">
						...
						<div class="grid_inner">
							<div class="grid_item wd55">
								<div class="courses_item">
									<img src="User/img/courses/course-1.jpg" alt="">
							...
							<div class="grid_item wd44">
								<div class="courses_item">
									<img src="User/img/courses/course-2.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Japanease Language Class</h4></a>
										<ul class="list">
							...
							<div class="grid_item wd44">
								<div class="courses_item">
									<img src="User/img/courses/course-4.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Japanease Language Class</h4></a>
										<ul class="list">
							...
							<div class="grid_item wd55">
								<div class="courses_item">
									<img src="User/img/courses/course-5.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Japanease Language Class</h4></a>
										<ul class="list">
        			...
        			<div class="col-lg-3">
        				<div class="course_item">
							<img src="User/img/courses/course-3.jpg" alt="">
							<div class="hover_text">
								<a class="cat" href="#">Free</a>
								<a href="#"><h4>Japanease Language Class</h4></a>
								<ul class="list">
        	...
        	<div class="container">
        		...
        		<div class="row team_inner">
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="User/img/team/team-1.jpg" alt="">
        						<div class="hover">
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="User/img/team/team-2.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="User/img/team/team-3.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="User/img/team/team-4.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        		...
        		<div class="testi_slider owl-carousel">
        			<div class="item">
        				<div class="testi_item">
							<img src="User/img/testimonials/testi-3.png" alt="">
       						<h4>Fannie Rowe</h4>
       						<ul class="list">
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="User/img/latest-blog/l-blog-1.jpg" alt="">
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="User/img/latest-blog/l-blog-2.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="User/img/latest-blog/l-blog-3.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="User/img/latest-blog/l-blog-4.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="User/User/js/jquery-3.3.1.min.js"></script>
        <script src="User/User/js/popper.js"></script>
        <script src="User/User/js/bootstrap.min.js"></script>
        <script src="User/User/js/stellar.js"></script>
        <script src="User/User/vendors/lightbox/simpleLightbox.min.js"></script>
        <script src="User/User/vendors/nice-select/js/jquery.nice-select.min.js"></script>
        <script src="User/User/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="User/User/vendors/isotope/isotope.pkgd.min.js"></script>
        <script src="User/User/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="User/User/vendors/popup/jquery.magnific-popup.min.js"></script>
        <script src="User/User/js/jquery.ajaxchimp.min.js"></script>
        <script src="User/User/vendors/counter-up/jquery.waypoints.min.js"></script>
        <script src="User/User/vendors/counter-up/jquery.counterup.js"></script>
        <script src="User/User/js/mail-script.js"></script>
        <script src="User/User/js/theme.js"></script>
    </body>
</html>